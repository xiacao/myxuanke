<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\wamp64\www\myxuanke\public/../application/admin\view\dept\lst.html";i:1526563063;s:71:"D:\wamp64\www\myxuanke\public/../application/admin\view\public\top.html";i:1508314157;s:72:"D:\wamp64\www\myxuanke\public/../application/admin\view\public\left.html";i:1526561356;}*/ ?>
<!DOCTYPE html>
...
<div class="layui-side layui-bg-black" id="SiteSidebar">
   ...
   <div class="layui-body layui-tab-content" id="connn" style=""> 
     <span class="layui-breadcrumb">
                    ...
                    <a href="<?php echo url('dept/lst'); ?>">教师信息</a>
    ...
    <table class="layui-table" lay-skin="row" lay-even=""> 
     ...
     <thead> 
      <tr> 
       ...
       <th style=" text-align:center;">系编号</th> 
     ...
     <tbody>   <?php if(is_array($depts) || $depts instanceof \think\Collection || $depts instanceof \think\Paginator): $i = 0; $__LIST__ = $depts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
      <tr> 
    
        <td style=" text-align:center;"><?php echo $vo['did']; ?></td> 
      
        <td style=" text-align:center;"><?php echo $vo['dname']; ?></td> 
         <td style=" text-align:center;"><?php echo $vo['sclass']; ?></td> 
          <td style=" text-align:center;"><?php echo $vo['ddesc']; ?></td> 
     
        <td align="center">
                                    <a href="<?php echo url('teacher/edit',array('id'=>$vo['did'])); ?>" class="btn btn-primary btn-sm shiny">
             ...
             btn: ['确定','取消'] //按钮
               ...
               document.location.href='<?php echo url('teacher/del',array('id'=>$vo['did'])); ?>';
            }, function(){
            layer.msg('已取消', {
            time: 2000, //2s后自动关闭
        ...
        <div id="layui-laypage-1" class="layui-box layui-laypage layui-laypage-default"><?php echo $depts; ?></div>
    </div>
