<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\wamp64\www\myxuanke\public/../application/index\view\teacher\lst.html";i:1527519574;s:71:"D:\wamp64\www\myxuanke\public/../application/index\view\public\top.html";i:1526027236;s:74:"D:\wamp64\www\myxuanke\public/../application/index\view\public\teleft.html";i:1508666960;}*/ ?>
<!DOCTYPE html>
            ...
            <table class="layui-table" lay-skin="row" lay-even="">
                ...
                <tbody> <?php if(is_array($coursedata) || $coursedata instanceof \think\Collection || $coursedata instanceof \think\Paginator): $i = 0; $__LIST__ = $coursedata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
                        ...
                        <td style=" text-align:center;"><?php echo $vo['ssex']; ?></td>
