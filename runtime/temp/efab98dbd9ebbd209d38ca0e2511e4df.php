<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\wamp64\www\myxuanke\public/../application/admin\view\course\lst.html";i:1509181832;s:71:"D:\wamp64\www\myxuanke\public/../application/admin\view\public\top.html";i:1508314157;s:72:"D:\wamp64\www\myxuanke\public/../application/admin\view\public\left.html";i:1527576101;}*/ ?>
<!DOCTYPE html>
...
<div class="layui-side layui-bg-black" id="SiteSidebar">
   ...
   <div class="layui-body layui-tab-content" id="connn" style=""> 
    ...
    <table class="layui-table" lay-skin="row" lay-even=""> 
     ...
     <tbody>   <?php if(is_array($courses) || $courses instanceof \think\Collection || $courses instanceof \think\Paginator): $i = 0; $__LIST__ = $courses;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
      <tr> 
        ...
        <td align="center">
                                    <a href="<?php echo url('course/edit',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny">
             ...
             btn: ['确定','取消'] //按钮
               ...
               document.location.href='<?php echo url('course/del',array('id'=>$vo['id'])); ?>';
            }, function(){
            layer.msg('已取消', {
            time: 2000, //2s后自动关闭
