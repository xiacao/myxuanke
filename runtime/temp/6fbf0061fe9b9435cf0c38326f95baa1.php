<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\wamp64\www\myxuanke\public/../application/admin\view\student\lst.html";i:1527519901;s:71:"D:\wamp64\www\myxuanke\public/../application/admin\view\public\top.html";i:1508314157;s:72:"D:\wamp64\www\myxuanke\public/../application/admin\view\public\left.html";i:1527576101;}*/ ?>
<!DOCTYPE html>
...
<div class="layui-side layui-bg-black" id="SiteSidebar">
   ...
   <div class="layui-body layui-tab-content" id="connn" style=""> 
     <span class="layui-breadcrumb">
                ...
                <br><br>
    <a href="<?php echo url('student/add'); ?>">
    ...
    <table class="layui-table" lay-skin="row" lay-even=""> 
     ...
     <tbody>   <?php if(is_array($students) || $students instanceof \think\Collection || $students instanceof \think\Paginator): $i = 0; $__LIST__ = $students;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
      <tr> 
        <td style=" text-align:center;"><?php echo $vo['sno']; ?></td> 
        <td style=" text-align:center;"><?php echo $vo['sname']; ?></td> 
       <td style=" text-align:center;"><?php if($vo['ssex'] == 0): ?>男<?php else: ?>女<?php endif; ?></td> 
       

         <td style=" text-align:center;"><?php echo $vo['sclass']; ?></td>  
       
        <td align="center">
            <a href="<?php echo url('student/edit',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny">
                <i class="fa fa-edit"></i> <button class="layui-btn"><i class="layui-icon">&#xe642;</i></button>

            </a>
                               
            <a href="#" class="btn btn-danger btn-sm shiny">
            <i class="fa fa-trash-o"></i> <button onclick=" layer.confirm('确定删除？', {btn: ['确定','取消'] },  function(){
                 
               document.location.href='<?php echo url('student/del',array('id'=>$vo['id'])); ?>';
            }, function(){
            layer.msg('已取消', {
            time: 2000, //2s后自动关闭
        ...
        <div id="layui-laypage-1" class="layui-box layui-laypage layui-laypage-default"><?php echo $students; ?></div>
    </div>
