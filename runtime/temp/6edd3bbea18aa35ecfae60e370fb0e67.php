<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"D:\wamp64\www\myxuanke\public/../application/admin\view\teacher\edit.html";i:1527579490;s:71:"D:\wamp64\www\myxuanke\public/../application/admin\view\public\top.html";i:1508314157;s:72:"D:\wamp64\www\myxuanke\public/../application/admin\view\public\left.html";i:1527576101;}*/ ?>
        ...
        <form class="layui-form" role="form" action="" method="post">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block " style="width: 40%">
                     <input type="text" name="tno" lay-verify="title" autocomplete="off" value="<?php echo $teacher['tno']; ?>" placeholder="请输入学号" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item ">
                <label class="layui-form-label">姓名</label>
                <div class="layui-input-block" style="width: 40%">
                    <input type="text" name="tname" lay-verify="title" autocomplete="off" value="<?php echo $teacher['tname']; ?>" placeholder="请输入姓名" class="layui-input">
                </div>
            </div>
             <div class="layui-form-item">
                ...
                <div class="layui-input-block " style="width: 40%">
                                  ...
                                  <input type="radio" <?php if($teacher['tsex'] == 0): ?>checked="checked" <?php endif; ?> class="layui-input" name="tsex" value="0" title="男"  >
                  <input type="radio" <?php if($teacher['tsex'] == 1): ?> checked="checked" <?php endif; ?> class="layui-input" name="tsex" value="1" title="女"  >
             ...
             <div class="layui-form-item ">
                ...
                <div class="layui-input-block" style="width: 40%">
                    <input type="text" name="tdept" lay-verify="title" autocomplete="off" value="<?php echo $teacher['tdept']; ?>"  placeholder="请输入专业" class="layui-input">
                </div>
            </div>
             <div class="layui-form-item ">
                <label class="layui-form-label">邮箱</label>
                <div class="layui-input-block" style="width: 40%">
                    <input type="text" name="temail" lay-verify="title" autocomplete="off" value="<?php echo $teacher['temail']; ?>" placeholder="请输入专业" class="layui-input">
                </div>
            </div>
