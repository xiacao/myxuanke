<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\wamp64\www\myxuanke\public/../application/admin\view\course\edit.html";i:1527578864;s:71:"D:\wamp64\www\myxuanke\public/../application/admin\view\public\top.html";i:1508314157;s:72:"D:\wamp64\www\myxuanke\public/../application/admin\view\public\left.html";i:1527576101;}*/ ?>
...
<div class="layui-side layui-bg-black" id="SiteSidebar">
        ...
        <div class="layui-body layui-tab-content" id="connn" style="bottom: 0px;">
                ...
                <span class="layui-breadcrumb">
                    ...
                    <a href="<?php echo url('course/lst'); ?>">课程信息</a>
                    <a href="#"><cite>课程修改</cite></a>
                </span>
                <br><br>
        ...
        <form class="layui-form" role="form" action="" method="post">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block " style="width: 40%">
                     <input type="text" name="name" lay-verify="title" autocomplete="off"  value="<?php echo $courses['cno']; ?>"  placeholder="请输入登录名称" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item ">
                <label class="layui-form-label">授课老师</label>
                <div class="layui-input-block" style="width: 40%">
                    <input type="text" name="password" lay-verify="title" autocomplete="off" value="<?php echo $courses['tno']; ?>" placeholder="请输入密码" class="layui-input">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block " style="width: 40%">
                     <input type="text" name="name" lay-verify="title" autocomplete="off"  value="<?php echo $courses['cname']; ?>"  placeholder="请输入登录名称" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label ">学分</label>
                <div class="layui-input-block " style="width: 40%">
                     <input type="text" name="name" lay-verify="title" autocomplete="off"  value="<?php echo $courses['ccredit']; ?>"  placeholder="请输入登录名称" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label ">课程描述</label>
                <div class="layui-input-block " style="width: 40%">
                     <input type="text" name="name" lay-verify="title" autocomplete="off"  value="<?php echo $courses['cdescribe']; ?>"  placeholder="请输入登录名称" class="layui-input">
                </div>
            </div>
