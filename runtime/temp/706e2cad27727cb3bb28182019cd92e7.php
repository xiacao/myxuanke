<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\wamp64\www\myxuanke\public/../application/admin\view\admin\lst.html";i:1509091126;s:71:"D:\wamp64\www\myxuanke\public/../application/admin\view\public\top.html";i:1508314157;s:72:"D:\wamp64\www\myxuanke\public/../application/admin\view\public\left.html";i:1527576101;}*/ ?>
<!DOCTYPE html>
...
<div class="layui-side layui-bg-black" id="SiteSidebar">
        ...
        <div class="layui-body layui-tab-content" id="connn" style="">
            ...
            <table class="layui-table" lay-skin="row" lay-even="">
                ...
                <tbody> <?php if(is_array($admins) || $admins instanceof \think\Collection || $admins instanceof \think\Paginator): $i = 0; $__LIST__ = $admins;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
                        <td style=" text-align:center;"><?php echo $vo['id']; ?></td>
                        <td style=" text-align:center;"><?php echo $vo['aname']; ?></td>
                        <td align="center">
             ...
             btn: ['确定','取消'] //按钮
               ...
               document.location.href='<?php echo url('admin/del',array('id'=>$vo['id'])); ?>';
            }, function(){
            layer.msg('已取消', {
            time: 2000, //2s后自动关闭
       
        });
});"  data-method="confirmTrans" class="layui-btn layui-btn-danger"><i class="layui-icon">&#xe640;</i></button>
                            </a>
                            <?php endif; ?>
                        </td>
                    </tr>
            ...
            <div class="layui-col-md12" style="float: right;">
                <div id="layui-laypage-1" class="layui-box layui-laypage layui-laypage-default"><?php echo $admins; ?></div>
            </div>
