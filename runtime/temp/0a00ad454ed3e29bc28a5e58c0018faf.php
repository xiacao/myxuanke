<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\wamp64\www\myxuanke\public/../application/admin\view\login\index.html";i:1508756825;}*/ ?>
﻿
    ...
    <div class="login-box">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="aname" autocomplete="off" class="layui-input" lay-verify="account"
        ...
        <div class="layui-form-item">
         ...
         <div class="loginbox-textbox">
                    <input class="form-control" placeholder="请输入验证码" name="code" style="margin:10px 0;width:85px;float:left;height: 30px;" type="text">
                    <img  style="float:left; cursor:pointer; margin-left:20px;  width: 180px;height: 40px;" src="<?php echo captcha_src(); ?>" alt="captcha" onclick="this.src='<?php echo captcha_src(); ?>?'+Math.random();" />
                </div>
        <div class="layui-form-item">
