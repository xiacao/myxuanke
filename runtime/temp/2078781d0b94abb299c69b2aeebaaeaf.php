<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"D:\wamp64\www\myxuanke\public/../application/index\view\teacher\data.html";i:1527519686;s:71:"D:\wamp64\www\myxuanke\public/../application/index\view\public\top.html";i:1526027236;s:74:"D:\wamp64\www\myxuanke\public/../application/index\view\public\teleft.html";i:1508666960;}*/ ?>
    ...
    <div class="layui-side-scroll">
        ...
        <div class="layui-body layui-tab-content" id="connn" style="bottom: 0px;">
            ...
            <span class="layui-breadcrumb">
                    <a href="<?php echo url('teacher/index'); ?>">首页</a>
            ...
            <form class="layui-form" role="form" action="" method="post">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block " style="width: 40%">
                        <input type="text" name="tno" id="sno"="sno" lay-verify="title" autocomplete="off" value="<?php echo $teachers['tno']; ?>" placeholder="请输入登录名称" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label ">姓名</label>
                    <div class="layui-input-block " style="width: 40%">
                        <input type="text" name="tname" id="tname" lay-verify="title" autocomplete="off" value="<?php echo $teachers['tname']; ?>" placeholder="请输入登录名称" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item ">
                    ...
                    <div class="layui-input-block" style="width: 40%">
                        ...
                        <input type="text" name="tsex" id="tsex" lay-verify="title" autocomplete="off" value="<?php echo $teachers['tsex']; ?>" placeholder="请输入密码" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item ">
                    ...
                    <div class="layui-input-block" style="width: 40%">
                        <input type="text" name="temail" id="temail" lay-verify="title" autocomplete="off" value="<?php echo $teachers['temail']; ?>" placeholder="请输入密码" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item ">
                    <label class="layui-form-label">密码</label>
                    <div class="layui-input-block" style="width: 40%">
                        <input type="text" name="pwd" id="pwd" lay-verify="title" autocomplete="off" value="<?php echo $teachers['pwd']; ?>" placeholder="请输入密码" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
