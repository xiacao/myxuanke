<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\wamp64\www\myxuanke\public/../application/admin\view\admin\edit.html";i:1509181790;s:71:"D:\wamp64\www\myxuanke\public/../application/admin\view\public\top.html";i:1508314157;s:72:"D:\wamp64\www\myxuanke\public/../application/admin\view\public\left.html";i:1527576101;}*/ ?>
...
<div class="layui-side layui-bg-black" id="SiteSidebar">
        ...
        <div class="layui-body layui-tab-content" id="connn" style="bottom: 0px;">
                ...
                <span class="layui-breadcrumb">
                    ...
                    <a href="<?php echo url('admin/lst'); ?>">管理员信息</a>
        ...
        <form class="layui-form" role="form" action="" method="post">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block " style="width: 40%">
                     <input type="text" name="name" lay-verify="title" autocomplete="off"  value="<?php echo $admins['aname']; ?>"  placeholder="请输入登录名称" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item ">
                <label class="layui-form-label">密码</label>
                <div class="layui-input-block" style="width: 40%">
                    <input type="text" name="password" lay-verify="title" autocomplete="off" value="<?php echo $admins['password']; ?>" placeholder="请输入密码" class="layui-input">
                </div>
            </div>
